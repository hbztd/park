                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-button type="text" @click="onClickEdit(scope.row)" size="small">重置</el-button>
    ...
    methods:{
      ...
      onClickEdit(row){
        ...
        this.$confirm('此操作将重置该用户, 是否继续?', '提示', {
          ...
          this.$axios
            .post('/api/user/update.do',JSON.stringify(row),{
              headers: {'Content-Type': 'application/json'}
            })
            .then((res) => {
              console.log(res);
      ...
      onClickDel(row){
        this.$confirm('此操作将删除该用户, 是否继续?', '提示', {
          ...
          this.$axios
            .post('/api/user/delete.do',this.$qs.stringify({account: row.account}))
            .then((res) => {
              console.log(res);
              if(res.data.status === 0) {
                this.$message({
